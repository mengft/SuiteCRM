...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.report_module.name}-input', '{$fields.report_module.name}');sync_{$fields.report_module.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
